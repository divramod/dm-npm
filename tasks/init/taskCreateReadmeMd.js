 ...
 */
job.create = co.wrap(function*(templateDirPath, npmModuleName, npmModuleShortcut, npmModuleDescription) {
    ...
    exec("sed -i 's:NPM_MODULE_DESCRIPTION:" + npmModuleDescription+ ":g' './" + filename + "'");
